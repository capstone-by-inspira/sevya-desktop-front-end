  ...
  return (
    <div className="login-page">
      ...
      <div className="login-form">
        <h5 className="font-weight-400">Login With Email</h5>
        <br/>
        ...
        <a  className="account-create" onClick={() => navigate("/signup")}>
          Don't have an account ? <span className="create-one">Create One!</span>
        </a>
      </div>
    </div>
  );
